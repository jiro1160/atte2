    ...
    <div class="button-container">
        <form class="form" action="/work/start" method="post">
            ...
            <div class="form__button">
                <button type="submit" class="form__button-submit">勤務開始</button>
            </div>
        </form>
        <form class="form" action="/work/end" method="post">
            @csrf
            <div class="form__button">
                <button type="submit" class="form__button-submit">勤務終了</button>
            </div>
        </form>
        <form class="form" action="/rest/start" method="post">
            @csrf
            <div class="form__button">
                <button type="submit" class="form__button-submit">休憩開始</button>
            </div>
        </form>
        <form class="form" action="/rest/end" method="post">
            @csrf
            <div class="form__button">
                <button type="submit" class="form__button-submit">休憩終了</button>
            </div>
        </form>
    </div>
